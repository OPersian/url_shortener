    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('original_url', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='shortening.originalurl')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='shortening.originalurl')),
            ],
            options={
