...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-8%jfcoazgeb376g^1_#po%umswmw#itun5%1-jql7#6av9p+mt')
...
INSTALLED_APPS = EXTERNAL_APPS + DEFAULT_APPS + CUSTOM_APPS
